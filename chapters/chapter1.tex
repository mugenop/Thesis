...
\begin{figure}[H] %
	\centering%
  \includegraphics[width=\textwidth]{figures/Chapter_1/raw_image.png}
...
\begin{figure}[H]%
	\centering%
	 \begin{subfigure}[h]{0.48\textwidth}%
        \includegraphics[width=\linewidth]{Figures/median_b.png}%
...
\begin{figure}[H] %
	\centering%
  \includegraphics[width=\textwidth]{figures/Chapter_1/canny.png}
...
\begin{figure}[H] %
	\centering%
  \includegraphics[width=\textwidth]{figures/Chapter_1/ball_shape.pdf}
	\caption{Ball shape}
