...
\begin{figure}[h] %
	\centering%
  \includegraphics[width=0.48\textwidth]{figures/Chapter_1/schematic_experimental_setup.png}
...
\begin{figure}[h] %
	\centering%
  \includegraphics[width=0.48\textwidth]{figures/Chapter_1/cuve_representation.png}
...
\begin{figure}[h] %
	\centering%
  \includegraphics[width=0.48\textwidth]{figures/Chapter_1/schematic_experimental_setup_light_lenses.png}
...
\begin{figure}[h] %
	\centering%
  \includegraphics[width=0.48\textwidth]{figures/Chapter_1/quasi_static_pressure_cycle.png}
...
\begin{figure}[h] %
	\centering%
  \includegraphics[width=0.48\textwidth]{figures/Chapter_1/dynamic_pressure_cycle.png}
